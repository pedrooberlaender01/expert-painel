...
export const InstanciaCard: React.FC<InstanciaCardProps> = ({
  numero,
  isFirst,
  isLast,
  onToggleAtivo,
  ...
  // Clear local pairing code when realtime updates bring a new one
  useEffect(() => {
  ...
  return (
    <div className={cn(
      ...
      {/* Local pairing code (from reconectar response, before realtime updates) */}
