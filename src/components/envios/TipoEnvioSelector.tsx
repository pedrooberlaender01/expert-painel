        ...
        return (
          <label
            ...
            className={cn(
              ...
              selected
                ? 'bg-primary/10 border-primary/30 shadow-[inset_0_0_20px_var(--color-primary-bg)]'
          ...
          >
            ...
            <div
              className={cn(
                ...
                selected ? 'border-primary' : 'border-surface-300/60'
              )}
            >
              {selected && (
            ...
            <opt.icon className={cn(
              ...
              selected ? 'text-primary' : 'text-txt-muted'
            )} />
            <span className={cn(
